...
- Embed screenshots as placeholder image tags with descriptive filenames pointing at an `img/` folder beside the document — `![Main window overview](img/main-window-overview.png)` — leaving the actual screenshots for the user to capture and save there.
